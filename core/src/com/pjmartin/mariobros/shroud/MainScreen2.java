...
public class MainScreen2 implements Screen, ContactListener {
    ...
    public MainScreen2(MarioBros play) {
        ...
        hud = new HUD(play.a, MarioBros.lives, MarioBros.marioScore,"1-2" );

        mapLoad = new TmxMapLoader();
        map = mapLoad.load("level2.tmx");
